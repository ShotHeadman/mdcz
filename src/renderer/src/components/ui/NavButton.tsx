  ...
  return (
    <Button
      ...
      className={cn(
        ...
        isActive
          ? "bg-transparent text-foreground font-bold before:absolute before:left-0 before:top-2 before:bottom-2 before:w-0.5 before:rounded-full before:bg-foreground"
