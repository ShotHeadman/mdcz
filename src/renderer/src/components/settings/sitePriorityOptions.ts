...
const SITE_PRIORITY_OPTION_DEFINITIONS: SitePriorityOptionDefinition[] = [
  {
    ...
    aliases: ["dmm", "dmm tv", "dmm_tv", "fanza", "dmm family", "dmm/fanza"],
  },
  {
    id: "official",
    label: "厂商官网",
  ...
  },
  {
    ...
    sites: [Website.JAVDB],
    aliases: ["aggregate", "preview", "cover", "cookie"],
  },
  {
    id: Website.JAVBUS,
    ...
    aliases: ["aggregate", "sample", "cookie", "adult verify"],
  },
  {
    id: Website.JAV321,
  ...
  },
  {
    ...
    sites: [Website.FC2],
    aliases: ["official product", "seller", "官方商品页"],
  },
  {
    id: Website.FC2HUB,
    ...
    aliases: ["fc2 aggregate", "runtime", "score"],
  },
  {
    ...
    aliases: ["fc2 fallback", "sample", "seller"],
  },
  {
    id: Website.SOKMIL,
    label: Website.SOKMIL,
    description: "日本成人视频与写真配信平台，偏写真/gravure 和特定配信内容补充；不建议作为通用主来源。",
