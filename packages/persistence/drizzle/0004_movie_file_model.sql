...
--> statement-breakpoint
DROP TABLE `scrape_run_items`;
--> statement-breakpoint
DROP TABLE `publication_journal`;
--> statement-breakpoint
DROP TABLE `library_repair_issues`;
--> statement-breakpoint
...
CREATE TABLE `library_item_assets` (
  ...
  CHECK ((`kind` = 'subtitle') = (`file_id` IS NOT NULL)),
...
--> statement-breakpoint
CREATE UNIQUE INDEX `library_item_files_entry_identity_idx` ON `library_item_files` (`entry_identity`);
--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE `scrape_runs` ADD `manifest_json` text;
--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE `scrape_runs` ADD `total_items` integer DEFAULT 0 NOT NULL;
--> statement-breakpoint
ALTER TABLE `scrape_runs` ADD `success_count` integer DEFAULT 0 NOT NULL;
--> statement-breakpoint
ALTER TABLE `scrape_runs` ADD `failed_count` integer DEFAULT 0 NOT NULL;
--> statement-breakpoint
ALTER TABLE `scrape_runs` ADD `skipped_count` integer DEFAULT 0 NOT NULL;
--> statement-breakpoint
