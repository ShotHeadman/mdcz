...
import type { ConfigPathInput, ConfigProfileNameResponse, ConfigUpdateInput } from "../serverDtos";
...
export type ConfigIpcContract = {
  ...
  [IpcChannel.Config_Save]: IpcProcedure<{ config?: ConfigUpdateInput }, Configuration>;
  [IpcChannel.Config_List]: IpcProcedure<void, { configPath: string; dataDir: string }>;
  [IpcChannel.Config_Reset]: IpcProcedure<{ path?: string }, Configuration>;
  ...
  [IpcChannel.Config_CreateProfile]: IpcProcedure<{ name?: string }, ConfigProfileNameResponse>;
  [IpcChannel.Config_SwitchProfile]: IpcProcedure<{ name?: string }, Configuration>;
  [IpcChannel.Config_DeleteProfile]: IpcProcedure<{ name?: string }, ConfigProfileNameResponse>;
